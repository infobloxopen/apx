...
- [x] T006 [P] Implement k3d cluster creation in tests/e2e/k3d/cluster.go
- [x] T007 [P] Implement k3d cluster configuration templates in tests/e2e/k3d/config.go
- [x] T008 [P] Implement k3d cleanup utilities in tests/e2e/k3d/cleanup.go

### Gitea Lifecycle Management

- [x] T009 [P] Implement Gitea container deployment in tests/e2e/gitea/lifecycle.go
- [x] T010 [P] Implement Gitea readiness checks and health validation in tests/e2e/gitea/lifecycle.go
- [x] T011 [P] Implement admin token creation in tests/e2e/gitea/lifecycle.go

### Gitea API Client

- [x] T012 [P] Implement repository operations (create, delete, get) in tests/e2e/gitea/client.go
- [x] T013 [P] Implement pull request operations (create, get, list, commits) in tests/e2e/gitea/client.go
- [x] T014 [P] Implement tag operations (list, get) in tests/e2e/gitea/client.go
- [x] T015 [P] Implement user operations (create user, create token) in tests/e2e/gitea/client.go

### Test Helpers

- [x] T016 [P] Implement git operations wrapper (clone, commit, tag, push) in tests/e2e/testhelpers/git.go
- [x] T017 [P] Implement APX command wrappers (init, publish, add, gen, sync) in tests/e2e/testhelpers/apx.go
- [x] T018 [P] Implement custom assertions (git history, PR state, file checks) in tests/e2e/testhelpers/assertions.go
- [x] T019 [P] Implement environment setup helper in tests/e2e/testhelpers/environment.go

### Test Fixtures

- [x] T020 [P] Create canonical repository seed data in tests/e2e/fixtures/canonical-repo/
- [x] T021 [P] Create app1 payment service test schemas in tests/e2e/fixtures/app1-payment/
- [x] T022 [P] Create app2 user service test schemas in tests/e2e/fixtures/app2-user/

### Integration with Existing Test Infrastructure

- [x] T023 Update testscript_test.go to conditionally setup Gitea for E2E scenarios
...
- [x] T024 [US1] Create e2e_complete_workflow.txt testscript in testdata/script/e2e/ covering all 5 acceptance scenarios:
...
- [x] T025 [P] [US2] Create e2e_cross_repo_deps.txt testscript in testdata/script/e2e/ covering acceptance scenarios 1-3:
...
- [x] T026 [P] [US2] Create e2e_catalog_validation.txt testscript in testdata/script/e2e/ covering acceptance scenario 4:
...
- [x] T027 [P] [US3] Create e2e_breaking_detection.txt testscript in testdata/script/e2e/ covering acceptance scenarios 1-2:
  - Detect breaking changes (removed field) via apx breaking
  - Block publication of breaking changes without --force flag

- [x] T028 [P] [US3] Create e2e_non_breaking_changes.txt testscript in testdata/script/e2e/ covering acceptance scenario 3:
  - Allow non-breaking changes (added optional field)

- [x] T029 [P] [US3] Create e2e_major_version_bump.txt testscript in testdata/script/e2e/ covering acceptance scenario 4:
...
- [x] T030 [US4] Create e2e_git_history.txt testscript in testdata/script/e2e/ covering all 3 acceptance scenarios:
...
- [x] T031 [P] Create e2e_gitea_unreachable.txt testscript in testdata/script/e2e/ testing Gitea unavailability error handling
- [x] T032 [P] Create e2e_existing_pr.txt testscript in testdata/script/e2e/ testing PR update when PR already exists
- [x] T033 [P] Create e2e_corrupted_git_history.txt testscript in testdata/script/e2e/ testing git subtree split failure
- [x] T034 [P] Create e2e_circular_deps.txt testscript in testdata/script/e2e/ testing circular dependency detection
- [x] T035 [P] Create e2e_duplicate_tag.txt testscript in testdata/script/e2e/ testing tag conflict error handling
- [x] T036 [P] Create e2e_overlay_deletion.txt testscript in testdata/script/e2e/ testing apx sync after manual overlay deletion
- [x] T037 [P] Create e2e_concurrent_publish.txt testscript in testdata/script/e2e/ testing multiple apps publishing to same module path
- [x] T038 [P] Create e2e_codeowners.txt testscript in testdata/script/e2e/ testing CODEOWNERS enforcement validation
...
- [x] T039 Add E2E test job to .github/workflows/test.yml for ubuntu-latest
- [x] T040 [P] Add optional macOS E2E test job to .github/workflows/test.yml (separate job)

### Documentation Updates

- [x] T041 [P] Update README.md with E2E test suite section and quickstart link
- [x] T042 [P] Create docs/testing/e2e-tests.md comprehensive developer guide
- [x] T043 [P] Add troubleshooting section to docs/troubleshooting/e2e-tests.md
...
- [x] T044 Add timeout validation to ensure full suite completes in <5 minutes (SC-001)
- [x] T045 Run E2E suite 10 times to validate zero flakiness (SC-007)
- [x] T046 [P] Optimize Gitea startup time with health check tuning
- [x] T047 [P] Add comprehensive error context messages per SC-004 requirement

### Final Validation

- [x] T048 Validate all 18 functional requirements from spec.md are covered by testscript scenarios
- [x] T049 Run cross-platform validation on Linux and macOS (SC-009)
- [x] T050 Verify cleanup leaves zero orphaned resources (docker ps, k3d cluster list)
- [x] T051 Execute quickstart.md validation to ensure developer documentation is accurate
